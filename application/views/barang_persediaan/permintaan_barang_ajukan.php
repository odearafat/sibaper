 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="x_title">
	  ...
	  <form id="inputPersediaanForm" kategori="permintaan" action="permintaanPersediaan<?php //echo base_url().$action;?>" enctype="multipart/form-data" method="post" id="demo-form" data-parsley-validate class="form-horizontal form-label-left">
		 <div width="100%">
		<table width="100%">
			<tr width="100%">
				<td width="10%" > Tanggal </td>
				<td width="30%" style="padding-bottom:1%"> <input id="birthday" name="tgl_keluar" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text"></td>
			</tr>
			<tr width="100%">
